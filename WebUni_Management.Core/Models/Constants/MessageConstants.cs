namespace WebUni_Management.Core.Models.Constants
{
    public static class MessageConstants
    {
        public const string RequiredErrorMessage = "The {0} field is required.";
        public const string UserNameLengthErrorMessage = "The {0} field must be {1} characters long.";
        ...
        public const string InvalidGrade = "Invalid grade. Should be between {2} and {1}.";
    }
}
